...
export const mockBarterNegotiations: BarterNegotiation[] = [
  ...
  },
  {
    ...
    senderId: '12',
    receiverId: '7',
    message: 'Hi! I\'m interested in the fitness equipment. I can create 3 Instagram posts and 1 workout video showcasing the products.',
    proposedProductValue: 18000,
    proposedContentValue: 15000,
    status: 'PENDING',
    createdAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    ...
    senderId: '2',
    receiverId: '6',
    message: 'I\'d love to work with your beauty products! I can offer 3 Instagram posts and 1 beauty tutorial video.',
    proposedProductValue: 12000,
    proposedContentValue: 10000,
    status: 'PENDING',
    createdAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    ...
    senderId: '11',
    receiverId: '1',
    message: 'I\'m interested in reviewing the smartphone. I can create a comprehensive tech review, 3 Instagram posts, and a comparison video.',
    proposedProductValue: 60000,
    proposedContentValue: 55000,
    status: 'PENDING',
    createdAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
  },
];
...
export const mockBarterDisputes: BarterDispute[] = [
  ...
  },
  {
    ...
    description: 'The content submitted does not meet our quality standards. The video quality is poor and does not showcase the product properly.',
    status: 'OPEN',
    createdAt: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    ...
    description: 'The content value does not match the agreed deliverables. Some promised content pieces are missing.',
    status: 'RESOLVED',
    resolvedAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
    resolution: 'Additional content was provided to match the agreed value.',
    createdAt: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString(),
  },
];
...
export const mockBarterReviews: BarterReview[] = [
  ...
  },
  {
    ...
    revieweeId: '1',
    rating: 5,
    comment: 'Great brand to work with! Product was exactly as described and communication was excellent throughout.',
    createdAt: new Date(Date.now() - 45 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'br4',
    ...
    revieweeId: '12',
    rating: 4,
    comment: 'Good content creator, delivered on time. Minor improvements could be made to video editing quality.',
    createdAt: new Date(Date.now() - 45 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'br5',
    ...
    revieweeId: '4',
    rating: 5,
    comment: 'Amazing fashion collection! The brand was professional and the products were high quality.',
    createdAt: new Date(Date.now() - 35 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'br6',
    ...
    revieweeId: '3',
    rating: 5,
    comment: 'Outstanding content! The creator really understood our brand and created beautiful content.',
    createdAt: new Date(Date.now() - 35 * 24 * 60 * 60 * 1000).toISOString(),
  },
];
...
export const mockBarterDeals: BarterDeal[] = [
  ...
  // More completed deals for history
  {
    id: 'bd12',
    productId: 'bp1',
    creatorId: '12',
